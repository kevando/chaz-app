...
import RecsByCategoryContainer from './RecsByCategoryContainer';
...
export default connect(mapStateToProps, {...RecActions, setAppData, signOut})(RecsByCategoryContainer);
